...
define gui.about = _p(""" В нашей истории главный герой, по имени Алекс, молодой и амбициозный специалист по информационной безопасности.
    
 Алекс только что приступил к работе в крупной технологической компании "Фортресс Текнолоджиз" в качестве аналитика по информационной безопасности.
""")
...
define config.save_directory = "Novella-1695303064"
